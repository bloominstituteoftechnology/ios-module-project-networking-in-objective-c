...
- (instancetype)initWithDictionary:(NSDictionary *)dictionary {
    ...
    NSDate *dateTime = [NSDate dateWithTimeIntervalSince1970:timeInMiliseconds / 0.0001];
    NSDate *dateSunrise = [NSDate dateWithTimeIntervalSince1970:sunriseTimeInMiliseconds / 0.0001];
    NSDate *dateSunset = [NSDate dateWithTimeIntervalSince1970:sunsetTimeInMiliseconds / 0.0001];
